...
import { Film, Calendar, Clock, Type, AlignLeft, AlertCircle, Save, User, Wand2 } from 'lucide-react';
import { createMovie, fetchOmdbData } from '../services/api';
  ...
  const handleAutoFill = async () => {
    ...
    try {
      ...
      setFormData(prev => ({
        ...
        genre: omdbData.Genre ? omdbData.Genre.split(',')[0].trim() : prev.genre,
